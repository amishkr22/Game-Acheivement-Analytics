import pandas as pd
from src.utils import connect_to_db, get_data_path

def load_data():
    conn = connect_to_db()
    cur = conn.cursor()

    players = pd.read_csv(get_data_path("players.csv"))
    ...
    games = pd.read_csv(get_data_path("games.csv"))
    ...
    achievements = pd.read_csv(get_data_path("achievements.csv"))
    ...
    times = pd.read_csv(get_data_path("time.csv"))
    ...
    achievement_facts = pd.read_csv(get_data_path("achievement_facts.csv"))
